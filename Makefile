...
MYLIBC_OBJS = $(addprefix $(BUILD)/mylibc/, my_string.o my_malloc.o)
...
$(BUILD)/httpd/response.o: httpd/response.h httpd/file.h httpd/io.h mylibc/my_string.h
$(BUILD)/httpd/file.o:     httpd/file.h httpd/io.h mylibc/my_string.h
$(BUILD)/httpd/env.o:      httpd/env.h httpd/log.h
$(BUILD)/httpd/log.o:      httpd/log.h
